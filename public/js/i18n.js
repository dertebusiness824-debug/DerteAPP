...
const dict = {
  es: {
    ...
    'push.cta': 'Activa las notificaciones push para recibir urgencias y reservas (app instalada).',
    ...
    'push.denied': 'Permiso de notificaciones denegado. Actívalo en Ajustes del sistema / del navegador.',
    'push.unsupported': 'Este navegador no admite Web Push. Instala DerteApp en la pantalla de inicio (iOS 16.4+ / Android Chrome).',
    'push.notConfigured': 'Push no configurado en el servidor (faltan claves VAPID).',
    'push.needInstall': 'Instala DerteApp en la pantalla de inicio y vuelve a activar los avisos push.',
  },
  en: {
    'nav.home': 'Home',
    ...
    'push.cta': 'Enable push notifications to receive urgencies and bookings (installed app).',
    ...
    'push.denied': 'Notification permission denied. Enable it in system / browser Settings.',
    'push.unsupported': 'This browser does not support Web Push. Install DerteApp on the home screen (iOS 16.4+ / Android Chrome).',
    'push.notConfigured': 'Push is not configured on the server (missing VAPID keys).',
    'push.needInstall': 'Install DerteApp on your home screen, then enable push alerts again.',
  },
};
