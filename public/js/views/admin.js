...
// Comisiones UI removed — Super Admin nav now opens Consultas (`admin-consultas.js`).
// Sales-rep assignment still lives in Ajustes and the /api/admin/sales-reps API.
