...
const paths = {
  ...
  mail: '<rect x="3.5" y="6" width="17" height="12" rx="2"/><path d="M4 7.5 12 13l8-5.5"/>',
  whatsapp:
  ...
  stethoscope:
    '<path d="M6 3.5v5a4.5 4.5 0 0 0 9 0v-5"/><path d="M4 3.5h3M14 3.5h3"/><path d="M10.5 13v3a4 4 0 0 0 8 0v-1.6"/><circle cx="18.5" cy="12.5" r="2"/>',
  camera:
    '<path d="M3.5 8.5A2 2 0 0 1 5.5 6.5h1.8l1.2-2h5l1.2 2h1.8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-11a2 2 0 0 1-2-2z"/><circle cx="12" cy="12.5" r="3.2"/>',
  trash:
    '<path d="M4.5 7h15M9.5 7V4.5h5V7M6.5 7l.8 12a2 2 0 0 0 2 1.9h5.4a2 2 0 0 0 2-1.9l.8-12"/><path d="M10.5 11v6M13.5 11v6"/>',
  minus: '<path d="M5.5 12h13"/>',
  tyre: '<circle cx="12" cy="12" r="8.5"/><circle cx="12" cy="12" r="3.5"/><path d="M12 3.5v5M12 15.5v5M3.5 12h5M15.5 12h5"/>',
};
