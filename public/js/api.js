...
export const api = {
  ...
  adminApivehiculoStatus: () => request('GET', '/admin/vehicles/apivehiculo'),
  adminSaveApivehiculoKey: (payload) => request('PATCH', '/admin/vehicles/apivehiculo', { body: payload }),
  adminPingApivehiculo: () => request('POST', '/admin/vehicles/apivehiculo/ping'),
