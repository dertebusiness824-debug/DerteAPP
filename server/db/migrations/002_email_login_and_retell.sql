...
ALTER TABLE shops ADD COLUMN IF NOT EXISTS retell_agent_id TEXT;
ALTER TABLE shops ADD COLUMN IF NOT EXISTS retell_did TEXT;

CREATE INDEX IF NOT EXISTS shops_retell_agent_idx ON shops (retell_agent_id) WHERE retell_agent_id IS NOT NULL;
